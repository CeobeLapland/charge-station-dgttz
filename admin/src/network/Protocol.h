...
const QString kAdminStationPause   = QStringLiteral("admin.station_pause");
const QString kAdminStationPauseResp = QStringLiteral("admin.station_pause_resp");
const QString kAdminStationResume  = QStringLiteral("admin.station_resume");
const QString kAdminStationResumeResp = QStringLiteral("admin.station_resume_resp");
const QString kAdminChargerAdd     = QStringLiteral("admin.charger_add");
const QString kAdminChargerAddResp = QStringLiteral("admin.charger_add_resp");
...
const QString kAdminChargerResume  = QStringLiteral("admin.charger_resume");
const QString kAdminChargerResumeResp = QStringLiteral("admin.charger_resume_resp");
